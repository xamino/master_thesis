...
%TODO the features should be less specific here: exact stuff I'd put into the description of each software piece I wrote.
...
If a user allows full access to the directory to an untrusted party there is little that we can do from a software design point to mitigate the security breach.
