...
Note that an actual study comparing our solution against other storage providers was not the intended goal of this thesis.
All information used to compare the different solutions is thus to be taken with a grain of salt.
