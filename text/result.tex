...
Care should be taken to ensure that the user does not provide the same access password than the passphrase used to access the Tinzenite encryption.

%TODO: expand on this

TODO: support for size limitations.
