...
It could be implemented by building on the shadow files capability described in section~\ref{subs:Shadow Objects}.
...
%TODO: expand on encrypted peer work?

\subsubsection{Shadow Objects}
\label{subs:Shadow Objects}
%TODO: rework when awake
