...
TODO: Rework, might have restructured a bit harshly. :P
%TODO see above
...
%TODO maybe I should start a glossary: list and differentiate between peers, connection type, ...
...
%TODO rework this stuff below a bit so it fits better with the things above.
...
Once connected a challenge is sent which contains a general identifier and an encrypted nonce.
The encrypted nonce is important to check whether the other peer is an encrypted one or a clear one.
If the sending peer is already encrypted the challenge is left out as it can not generate a valid one anyway.
%TODO change diagram to reflect this!
...
Therefore we will utilize a random back-off timer for sending the initial challenge.
