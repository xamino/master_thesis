...
For a more in depth look into how the mechanism works see section~\ref{subs:Challenge Response}.
...
Except: update encrypted stuff to reference notify message.
Authentication message may also need references to it.
...
When a Tinzenite directory is created the initial model of the directory is created and stored as described in section~\ref{TODO}.
...
TODO: go into a bit more detail?
Hash and modtime stuff?
