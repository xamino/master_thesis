...
\end{modellist}
\end{modellist}
\caption[Removed Folder Structure]{Example of the removed directory with an active removal pending. Note the missing file in done which would signify the completion of the removal.}
...
TODO: rewrite this to handle all temp dirs, local dir, etc.
