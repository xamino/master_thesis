...
Without checks this can be used to introduce bogus updates into the system: random data can be used to overwrite valid files with the modify operation and create, remove, and move updates initiated.
...
% TODO
More difficult is catching the illegal introduction of create, move, and remove updates.
TODO: I require a solution for this.
How do I ensure that only valid updates are accepted?
Watch out for providing both original and encrypted original in the same message: this will allow the encryption key to be calculated trivially!
