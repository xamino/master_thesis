...
\begin{figure}[htp]
    ...
    \end{lstlisting}
\caption[Authentication JSON Object]{TODO}
...
Apart from the Tox identification we require to allow connections we also store a date that represents the date of when the peer was last seen.
