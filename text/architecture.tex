...
The key \textit{"Object"} contains the object representation for the updated object as seen in section~\ref{sec:Peer Data Model}.
...
For the peers and authentication file the different value of \textit{"ObjType"} will allows the encrypted peer to place these unencrypted files in a different location than the normal data.
