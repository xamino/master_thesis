...
For trusted peers the peer will send an update message (although it must not: remote trusted peers will fetch updates themselves whenever requesting an update on the model).
