...
%TODO
TODO: need to mention core package here too
...
%TODO: build this in here, maybe specifically
...
%TODO not done, mention highlights!
TODO: missing highlights

\subsection{Server}
\label{sub:Server}

TODO: expand on encryption and server package.
Specifically mention and show store interface!
